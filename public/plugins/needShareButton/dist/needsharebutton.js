    ...
    window.needShareDropdown = function (elem, options) {
        ...
        ***********************************************/
        ...
        root.share = {
            ...
            'telegram': function () {
                var url = root.options.protocol + 'telegram.me/share/url?';
                url += encodeURIComponent(root.options.title) + encodeURIComponent(root.options.url);

                root.popup(url);
            },
            'whatsapp': function () {
                var url = root.options.protocol + 'whatsapp://send?';
                url += encodeURIComponent(root.options.title) + encodeURIComponent(root.options.url);
        ...
        ***********************************************/
        ...
        root.options = {
            ...
            buttonText: 'به اشتراک گذاری آلبوم',
            protocol: ['http', 'https'].indexOf(window.location.href.split(':')[0]) === -1 ? 'https://' : '//',
            url: window.location.href,
            title: root.getTitle(),
            image: root.getImage(),
            description: root.getDescription(),
            networks: 'Mailto,Telegram,Whatsapp,Twitter,Pinterest,Facebook,GooglePlus,Reddit,Delicious,Tapiture,StumbleUpon,Linkedin,Slashdot,Technorati,Posterous,Tumblr,GoogleBookmarks,Newsvine,Pingfm,Evernote,Friendfeed,Vkontakte,Odnoklassniki,Mailru'
        }
