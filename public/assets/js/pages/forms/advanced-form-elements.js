...
$(function () {
	...
	$demoMaskedInput.find('.time24').inputmask('99:99', { placeholder: '__:__ _m', alias: 'time24', hourFormat: '24' });
	...
	//Phone Number
	$demoMaskedInput.find('.phone-number').inputmask('099-99999999', { placeholder: '0__-________' });

	//Dollar Money
	$demoMaskedInput.find('.money-dollar').inputmask('alias', { placeholder: 'currency' });
	//Euro Money
	...
	$demoMaskedInput.find('.url').inputmask({ alias: "url" });
