...
function dataGrowChart(user_grow, album_grow, podcast_grow) {
    var options = {
        colors : ['#2f9ef4', '#fca041', '#3adb9e'],
        chart: {
            height: 350,
            type: 'bar',
        ...
        series: [{
            name: 'تعداد کاربران',
            data: [user_grow[4], user_grow[3], user_grow[2], user_grow[1]],
            style: {
                colors: '#5e6064',
            },
        }, {
            name: 'تعداد آلبوم ها',
            data: [album_grow[4], album_grow[3], album_grow[2], album_grow[1]]
        }, {
            name: 'تعداد پادکست ها',
            data: [podcast_grow[4], podcast_grow[3], podcast_grow[2], podcast_grow[1]]
        }],
        xaxis: {
            categories: ['سه ماه گذشته', 'دوماه گذشته', 'ماه گذشته', 'ماه اخیر'],
            labels: {
                style: {
                    colors: '#9aa0ac',
                }
...
function siteDataChart(cat, album, user, pod) {
    //pie chart
